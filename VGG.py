    ...
    for epoch in tqdm_iter:
        ...
        for phase in ['train', 'test']:
            ...
            if phase == 'test' and epoch_acc > best_acc:
                best_acc = epoch_acc
                best_model_wts = copy.deepcopy(model.state_dict())
                torch.save(model.state_dict(), 'res/best_model_wts_vgg.pth')
        print()
...
# The in_features attribute of the last layer gives the number of input features it expects
...
model_ft = train_model(model_ft, criterion, optimizer_ft, exp_lr_scheduler,
                       num_epochs=20, result_file_name=f"{formatted_time} - vgg11_LR_0.00001_2.csv")
